...
const App = (() => {
  ...
  const PAGES = {
    ...
    pessoal:    { title: 'Meu Financeiro',  module: Pessoal,     addLabel: '+ Despesa Pessoal' },
    agenda:     { title: 'Agenda Pessoal',  module: Agenda,      addLabel: '+ Novo Bloco' },
    ...
    plano:      { title: 'Plano de Negócios', module: Plano,     addLabel: '+ Nova Ação' },
  ...
  const _ENTITY_PAGE = {
    ...
    pessoal_lancamentos: 'pessoal', plano_acoes: 'plano', agenda_pessoal: 'agenda',
    metas: 'metas',
